define("app/src/desktop/main", ["lib/jquery-lib", "lib/util", "lib/contextMenu/jquery-contextMenu", "lib/artDialog/jquery-artDialog", "lib/picasa/picasa", "../../common/taskTap", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "../../common/rightMenu", "./fileSelect", "./ui", "../explorer/path", "../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer"], function (e) {
    ...
    return {
        filetype: {
            ...
            void 0 == e && (e = G.is_root ? "system" : "user"), void 0 == window.top.frames.Opensetting_mode ? $.dialog.open("./user/setting/" + e, {
                id: "setting_mode",
                fixed: !0,
            ...
            if ("url" == app.type) {
                ...
                var host = window.location.protocol +'//'+G.web_host;
                var icon = window.location.protocol +'//'+G.web_host+app.icon;
                var url = host +'/openApp/index/group/'+ app.group +'/path/'+ encodeURIComponent(app.path)+'/name/'+encodeURIComponent(app.name.replace(".oexe", ""))+'/icon/'+ encodeURIComponent(icon);
...
}),  define("app/common/rightMenu", [], function (require, exports) {
    ...
    var a = function () {
        ...
        0 != e && (G.sort_field = e, $(".menu_set_sort").removeClass("selected"), $(".set_sort_" + e).addClass("selected")), 0 != a && (G.sort_order = a, $(".menu_set_desc").removeClass("selected"), $(".set_sort_" + a).addClass("selected")), r(!1, !0), $.ajax({url: "index.php?setting/set&k=list_sort_field,list_sort_order&v=" + G.sort_field + "," + G.sort_order})
    }, n = function () {
        var e = 91;
    ...
    this._hover_title = function (e) {
        ...
        if ("oexe" == e.ext && void 0 != e.icon) {
            ...
            var s = core.path2url(G.this_path + e.name), o = "index.php?explorer/image&path=" + urlEncode(G.this_path + e.name);
    ...
    var o = function (e) {
        ...
        if (void 0 == e && (e = !0), void 0 == a && (a = !1), e)$.ajax({
            url: "/api/pathList?type=desktop&path=" + G.this_path,
            dataType: "json",
            error: core.ajaxError,
            success: function (e) {
            ...
            url: "/api/pathList?type=desktop&path=*recycle*/",
            dataType: "json",
            error: core.ajaxError,
            success: function (e) {
                if (!e.code)return !1;
    ...
    var s = function (e, a, t) {
        ...
        $.ajax({
            dataType: "json", url: "index.php?explorer/historyBack", beforeSend: function () {
        ...
        $.ajax({
            dataType: "json", url: "index.php?explorer/historyNext", beforeSend: function () {
                $(".tools-left .msg").stop(!0, !0).fadeIn(100)
            }, error: core.ajaxError, success: function (e) {
                return $(".tools-left .msg").fadeOut(100), e.code ? (e = e.data, G.this_path = e.thispath, G.json_data = e.list, Global.historyStatus = e.history_status, ui.f5(!1, !0), ui.header.updateHistoryStatus(), ui.header.addressSet(), void 0) : (core.tips.tips(e), $(Config.FileBoxSelector).html(""), !1)
            }
    ...
    return {
        ...
        recycle_clear: function () {
            $.dialog({
                ...
                ok: function () {
                    $.ajax({
                        url: "index.php?explorer/pathDeleteRecycle", beforeSend: function () {
                            core.tips.loading()
                        }, error: core.ajaxError, success: function (e) {
    ...
    var t = ["/", "\\", ":", "*", "?", '"', "<", ">", "|"], i = function (e) {
        ...
        if (!(1 > e.length)) {
            var t = e[0].path, i = LNG.remove_title, s = t + "<br/><br/>" + LNG.remove_info, o = "index.php?explorer/pathDelete";
        ...
        if (e) {
            var t = "/desktop/pathPast?path=" + urlEncode2(e);
            $.ajax({
        ...
        var t = "/desktop/pathInfo";
        G.share_page !== void 0 && (t = "/desktop/pathInfo?user=" + G.user + "&sid=" + G.sid), $.ajax({
            url: t,
            type: "POST",
            dataType: "json",
            data: n(e),
        ...
        $.ajax({
            url: "index.php?explorer/clipboard", dataType: "json", error: core.ajaxError, success: function (e) {
    ...
    var a = function (e, a) {
        ...
        if (G.share_page !== void 0)var a = G.app_host + "index.php?share/officeView&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode2(e);
        art.dialog.open(a, {
            ico: core.ico("doc"),
