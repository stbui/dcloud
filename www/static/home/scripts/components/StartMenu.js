        ...
        return (
            <div className={`startmenu open`}>
                ...
                <ul className="startmenu-quick">
                    ...
                    <li><a href="javascript:;" onClick={this.onHandleProxyClick}>{types.USER_PROFILES_PROXY}</a></li>
                    <li><a href="/admin">{types.USER_PROFILES_SYSTEM}</a></li>
                    <li><a href="javascript:;" onClick={this.onHandleHelpClick}>{types.USER_PROFILES_HELP}</a></li>
                </ul>
